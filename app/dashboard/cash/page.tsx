...
import { CashUpForm } from "@/components/cash-up-form";
import {
  Banknote,
  TrendingUp,
  TrendingDown,
    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Track cash and daily reconciliation
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="transactions">
        <TabsList className="mb-6">
          ...
          {isManager && <TabsTrigger value="cash-up">End of Day Cash Up</TabsTrigger>}
        </TabsList>
